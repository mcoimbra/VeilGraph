...
set output 'amazon-2008-complete-update-and-computation-time-bar-group-plot.pdf'
...
plot 'amazon-2008-40000-random-start_30_data_time_stats.tsv' using 2:xtic(1) ti "I/O" fc rgb graph_update_color, \
...
set output 'amazon-2008-summarized-update-and-computation-time-bar-group-plot.pdf'
plot 'amazon-2008-40000-random-start_30_data_time_stats.tsv' using 8:xtic(1) ti "I/O" fc rgb graph_update_color, \
...
plot newhistogram "1", 'amazon-2008-40000-random-start_30_data_time_stats.tsv' using 6:xtic(1) with boxes ti "Computation" fc rgb computation_time_color, \
'' u 4:xtic(1) with boxes ti "Integration" fc rgb total_update_color, \
'' u 2:xtic(1) with boxes ti "I/O" fc rgb graph_update_color, \
newhistogram "2", 'amazon-2008-40000-random-start_30_data_time_stats.tsv'  using 12:xtic(1) ti "Computation" fc rgb graph_update_color, \
'' u 10 ti "Integration" fc rgb total_update_color, \
