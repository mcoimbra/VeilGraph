...
set output 'amazon-2008-scalability-summarized-speedup-candle-plot.pdf'
...
plot 'amazon-2008-40000-random-start_30_data_summarized_stats.tsv' using 1:($6-$7):($6-$7):($6+$7):($6+$7) linecolor rgb '#3399ff' with candlesticks 
