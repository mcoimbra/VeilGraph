...
mkdir -p $VEILGRAPH_ROOT/Documents/datasets/web/eu-2015-host-40000-random
gsutil cp -r gs://$GS_BUCKET_DATASETS_DIR/web/eu-2015-host-40000-random/* $VEILGRAPH_ROOT/Documents/datasets/web/eu-2015-host-40000-random/

mkdir -p $VEILGRAPH_ROOT/Documents/datasets/social/hollywood-2011-40000-random
gsutil cp -r gs://$GS_BUCKET_DATASETS_DIR/social/hollywood-2011-40000-random/* $VEILGRAPH_ROOT/Documents/datasets/social/hollywood-2011-40000-random/
...
sudo chmod -R 640 $VEILGRAPH_ROOT/Documents/datasets/web/eu-2015-host-40000-random/*
sudo chmod -R 640 $VEILGRAPH_ROOT/Documents/datasets/social/amazon-2008-40000-random/*
sudo chmod -R 640 $VEILGRAPH_ROOT/Documents/datasets/social/hollywood-2011-40000-random/*
...
# TODO: this script should be adapted to use an operating system or version of Debian/Ubuntu that allows installing the latest Python 3 version from the package manager.
# When that is done, this section of dowloading and compiling Python 3 can be removed.
