...
import pt.ulisboa.tecnico.veilgraph.model.GraphModel;
import pt.ulisboa.tecnico.veilgraph.output.DiscardingGraphOutputFormat;
import pt.ulisboa.tecnico.veilgraph.output.GraphOutputFormat;
import pt.ulisboa.tecnico.veilgraph.util.GraphUtils;
...
public abstract class GraphStreamHandler<R> implements Runnable {
    ...
    /**
     * Object abstracting the reception of graph stream updates.
     */
    ...
    private void configureFlink(final Map<String, Object> argValues) {
        ...
        if(argValues.containsKey(ParameterHelper.VeilGraphArgumentName.FLINK_PRINT_SYSOUT.toString())) {
            ...
            //TODO: replace this line with Flink 1.14 equivalent.
        }
        else {
...
*/
     ...
     * It is abstract in this class and supposed to be implemented in a sub-class (e.g. {@link pt.ulisboa.tecnico.veilgraph.algorithm.pagerank.PageRankStreamHandler#init()}).
     * @throws Exception
     */
